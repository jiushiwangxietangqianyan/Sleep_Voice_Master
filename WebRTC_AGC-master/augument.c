...
void augument(char *in_file,char *out_file) {
    //char *in_file ="/Users/a0412/Downloads/WebRTC_AGC-master/cmake-build-debug/sample_out.wav";
    char drive[3];
    char dir[256];
    char fname[256];
    char ext[256];
